...
|**forward\_operation\_name**|`boolean`|When enabled, forwards client operation name to subgraphs.<br/>The operation name will include subgraph name, fetch node id and operation name from the client request.<br/>Format: <Client Operation Name>_<Subgraph Name>_<Fetch Node ID><br/>Default: `false`<br/>||
...
|**forward\_operation\_name**|`boolean`, `null`|When enabled, forwards client operation name to the selected subgraph.<br/>The operation name will include subgraph name, fetch node id and operation name from the client request.<br/>Format: <Client Operation Name>_<Subgraph Name>_<Fetch Node ID><br/><br/>This setting takes precedence over the value set in `all` section.<br/>||
