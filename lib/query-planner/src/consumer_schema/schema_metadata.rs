...
use crate::{
    consumer_schema::introspection::introspection_query_from_ast,
    state::supergraph_state::SchemaDocument,
};

pub type PossibleTypesMap = HashMap<String, HashSet<String>>;

#[derive(Debug, Clone)]
pub struct SchemaMetadata {
    pub possible_types: PossibleTypesMap,
...
pub fn create_schema_metadata(schema: &SchemaDocument) -> SchemaMetadata {
    ...
    let introspection_query = introspection_query_from_ast(schema);
