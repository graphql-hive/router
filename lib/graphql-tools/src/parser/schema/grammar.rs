...
use crate::parser::common::{default_value, directives, parse_type, string, Text};
use crate::parser::helpers::{ident, kind, name, punct};
use crate::parser::tokenizer::{Kind as T, Token, TokenStream};
    ...
    T: Text<'a>,
{
    ...
    (
        ...
        .map(|(descr, mut def)| {
            use super::ast::Definition::TypeDefinition as T;
...
mod test {
    ...
    fn ast<'a>(s: &'a str) -> Document<'a, String> {
