...
## [2.0.0](https://github.com/graphql-hive/router/compare/hive-router-plan-executor-v1.0.4...hive-router-plan-executor-v2.0.0) - 2025-09-18

### Other

- Add cancellation and deduplication to the query planner ([#427](https://github.com/graphql-hive/router/pull/427))
