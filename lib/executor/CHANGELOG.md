...
## [1.0.5](https://github.com/graphql-hive/router/compare/hive-router-plan-executor-v1.0.4...hive-router-plan-executor-v1.0.5) - 2025-09-16

### Other

- *(deps)* update actions-rust-lang/setup-rust-toolchain digest to 2fcdc49 ([#420](https://github.com/graphql-hive/router/pull/420))
