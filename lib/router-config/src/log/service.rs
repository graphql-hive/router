...
pub struct LogFieldsConfig {
    ...
    #[serde(default)]
    pub subgraph: SubgraphLogFieldsConfig,
}
...
#[derive(Clone, Debug, Deserialize, Serialize, JsonSchema, Default)]
#[serde(deny_unknown_fields)]
pub struct SubgraphLogFieldsConfig {
    #[serde(default)]
    pub request: SubgraphRequestLogFieldsConfig,
    #[serde(default)]
    pub response: SubgraphResponseLogFieldsConfig,
}

#[derive(Clone, Debug, Deserialize, Serialize, JsonSchema)]
#[serde(deny_unknown_fields, default)]
pub struct SubgraphRequestLogFieldsConfig {
    pub operation: bool,
...
#[derive(Clone, Debug, Deserialize, Serialize, JsonSchema)]
#[serde(deny_unknown_fields, default)]
pub struct SubgraphResponseLogFieldsConfig {
    pub error_count: bool,
}

impl Default for SubgraphRequestLogFieldsConfig {
    fn default() -> Self {
        SubgraphRequestLogFieldsConfig {
            operation: true,
...
impl Default for SubgraphResponseLogFieldsConfig {
    fn default() -> Self {
        SubgraphResponseLogFieldsConfig { error_count: true }
    }
}
