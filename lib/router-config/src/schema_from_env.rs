...
/// [`crate::from_env::resolve_from_env_placeholders`] accepts at runtime: any scalar field, and
/// any branch of an existing "either/or" union (e.g. [`crate::primitives::toggle::ToggleWith`],
/// [`crate::primitives::single_or_multiple::SingleOrMultiple`],
/// [`crate::primitives::value_or_expression::ValueOrExpression`]).
