...
impl PipelineErrorVariant {
    ...
    pub fn default_status_code(&self, prefer_ok: bool) -> StatusCode {
        match (self, prefer_ok) {
            ...
            (Self::FailedToParseBody(_), _) => StatusCode::UNPROCESSABLE_ENTITY,
            (Self::FailedToParseVariables(_), _) => StatusCode::UNPROCESSABLE_ENTITY,
            (Self::FailedToParseExtensions(_), _) => StatusCode::UNPROCESSABLE_ENTITY,
