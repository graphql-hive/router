...
use hive_router::{
    ...
    BoxError, PluginRegistry, RouterSharedState, SchemaState,
};
...
> {
    ...
    _init_router_from_config(router_config, None).await
}
...
pub async fn init_router_from_config_inline(
    ...
    BoxError,
> {
    _init_router_from_config_inline(config_yaml, None).await
}
...
pub async fn init_router_from_config_inline_with_plugins(
    ...
    BoxError,
> {
    _init_router_from_config_inline(config_yaml, Some(plugin_registry)).await
}
