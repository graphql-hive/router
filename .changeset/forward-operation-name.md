...
The operation name is injected (opt-in) into the query document and the `operationName` JSON field, formatted as `<client_operation_name>_<subgraph_name>_<fetch_step_id>`, when sending requests to subgraphs.
